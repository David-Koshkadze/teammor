...
config :teammor, TeammorWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TeammorWeb.ErrorHTML, json: TeammorWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Teammor.PubSub,
  live_view: [signing_salt: "/Mb6Wb6W"]
...
config :teammor, Teammor.Mailer, adapter: Swoosh.Adapters.Local
